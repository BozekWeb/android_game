...
public interface Generator {
    ...
    public static enum GenerationMode {
        ...
        ADD {
            @Override
            public void modify(final Float2D grid, final int x, final int y, final float value) {
                grid.add(x, y, value);
            }
        },
        ...
        public abstract void modify(Float2D grid, int x, int y, float value);
    }
}
